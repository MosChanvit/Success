    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tv_answer.getText().toString().equals("")){
                    Toast toast = Toast.makeText ( play2.this, "ใส่คำตอบก่อนดิ", Toast.LENGTH_SHORT );
                    toast.show ( );
                }
                else {
                    ...
                    if (oper.equals("+") && oper2.equals("+")) {
                        if (Integer.parseInt(d1) + Integer.parseInt(d2) + Integer.parseInt(d3) == Integer.parseInt(ans)) {
                            ...
                            Mscore += 2;
                            score.setText(Integer.toString(Mscore));
                            MediaPlayer ye = MediaPlayer.create(play2.this, R.raw.ye);
                            ye.start();
                            ...
                            if(Mscore>0){
                                Mscore -= 1;
                                Toast toast = Toast.makeText(play2.this, "ลบ 1 คะเเนน", Toast.LENGTH_SHORT);
                                toast.show();}
        ...
        CountDownTimer cdt = new CountDownTimer(1000*60, 1000) {
            ...
            public void onFinish() {
                ...
                Mscore = s;
                Intent intent = new Intent(play2.this, scorecount.class);
